...
import { SiReact, SiTypescript, SiTailwindcss, SiNodedotjs, SiMongodb } from "react-icons/si";
        ...
        <div className="grid grid-col-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-8">
              <FadeIn delay={60}>
                <div className="inline-flex items-center gap-2.5 px-5 py-2.5 border border-primary/50 bg-linear-to-r from-primary/30 to-primary-20 rounded-full w-fit">
                  <Code2 className="h-6 w-6 text-primary" />
                  <span className="text-md text-primary font-semibold">Full-Stack Developer</span>
              ...
              <div className="grid grid-cols-3 gap-8">
                {ABOUT_STATS.map((stat, index) => (
                  <div key={index} className="relative">
                    <div className="absolute -left-4 top-0 w-1 h-full bg-linear-to-r from-primary via-primary/60 to-primary/20 rounded-full"></div>
          ...
          <FadeIn delay={200}>
            <div className="grid grid-cols-2 gap-4">
              <div className="col-span-2 relative group">
                <div className="absolute inset-0 bg-linear-to-br from-primary/15 via-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-all duration-300"></div>
